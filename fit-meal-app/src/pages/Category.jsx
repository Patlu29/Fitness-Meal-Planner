  ...
  return (
    <div className="category-container">
      ...
      <p className="category-description">
        Explore a variety of food categories tailored to your health and fitness
        goals.
      </p>
      <div className="category-grid">
        <div className="category-card">
          ...
          <p className="category-info">
            Boost muscle repair and growth with lean protein sources like
        ...
        <div className="category-card">
          ...
          <p className="category-info">
            Packed with essential vitamins, minerals, and fiber for optimal
            health.
          </p>
        </div>
        <div className="category-card">
        ...
        <div className="category-card">
          ...
          <p className="category-info">
            Energize your workouts with whole grains, quinoa, and sweet
            potatoes.
          </p>
        </div>
      </div>
